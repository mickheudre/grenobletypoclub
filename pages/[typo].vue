<template>
    <div class="flex flex-col my-8 mx-8 max-w-4xl h-full">
        ...
        <div class="my-16">
            ...
            <a  :href="`/${font.data.value?.api.name}.zip`" :download="`${font.data.value?.api.name}.zip`" :aria-label="`Télécharger ${font.data.value?.api.name}`"><Download class="h-20 w-20 fill-green hover:rotate-45 origin-center transition duration-150 mx-auto my-16 "/></a>
